...
insert into job values(job_sql.nextval,1002,'编程','qq客服','网络客服','全职','3k','3.5k','2017-4-3','福利','清华硕士')
insert into job values(job_sql.nextval,1002,'编程','微信客服','网络客服','兼职','3k','5k','2017-4-3','五险一金···','本科')

update job set job_name='qq客服', job_tags='编程', job_department='网路客服', job_nature='兼职', job_min_salary='2k' ,job_max_salary='3k' ,job_attract='兼职还要福利？', job_ftime='2017-4-6', job_request='兼职还要福利？' where job_id=1017; 
update job set job_request='清华硕士' where job_id=1001
delete from job where job_id=1014;
select * from job
drop table job;
--职位表
create table job(
