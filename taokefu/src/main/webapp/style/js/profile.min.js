...
function file_check(obj, action_url, id) {
    ...
    0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt) ? (errorTips("只支持word、pdf、ppt、txt、wps格式文件，请重新上传"),
    $("#loadingImg").css("visibility", "hidden")) : $.ajaxFileUpload({
        type: "POST",
        url: action_url,
        secureuri: !1,
        fileElementId: id,
        ...
        success: function(jsonStr) {
            ...
            json.success ? (html = '<a href="' + ctx + '/nearBy/downloadResume" class="resume_download" title="下载' + json.content.nearbyName + '">' + json.content.nearbyName + "</a>" + '<a  class="fr del" href="javascript:;">删除</a><br /><span class="c9">上传时间：' + json.content.time + "</span>",
            $("#myResume .resumeUploadDiv").html(html),
            $("#myResume h2 a").html("重新上传"),
            $.colorbox({
                inline: !0,
...
!function(a, b) {
    ...
    function d(b) {
        ...
        d.length ? ("0,0,0,0" === d.join() && a.extend(d, n.transparent),
        c) : n[b]
    }
    function e(a, b, c) {
        return c = (c + 1) % 1,
    ...
    i.fn = a.extend(i.prototype, {
        parse: function(e, f, g, h) {
            if (e === b)
                ...
                this;
            (e.jquery || e.nodeType) && (e = a(e).css(f),
            f = b);
            var k = this
              , l = a.type(e)
              , m = this._rgba = [];
            return f !== b && (e = [e, f, g, h],
            l = "array"),
            "string" === l ? this.parse(d(e) || n._default) : "array" === l ? (o(j.rgba.props, function(a, b) {
                m[b.idx] = c(e[b.idx], b)
            }),
            this) : "object" === l ? (e instanceof i ? o(j, function(a, b) {
                ...
                k[f] && a.inArray(null, k[f].slice(0, 3)) < 0 && (k[f][3] = 1,
                d.from && (k._rgba = d.from(k[f])))
            }),
            this) : void 0
        },
        is: function(a) {
    ...
    o(j, function(d, e) {
        var f = e.props
          ...
          , k = e.from;
        i.fn[d] = function(d) {
            if (j && !this[h] && (this[h] = j(this._rgba)),
            d === b)
                return this[h].slice();
        ...
        o(f, function(b, c) {
            i.fn[b] || (i.fn[b] = function(e) {
                ...
                return "undefined" === f ? j : ("function" === f && (e = e.call(this, j),
                f = a.type(e)),
                null == e && c.empty ? this : ("string" === f && (k = g.exec(e),
                k && (e = j + parseFloat(k[2]) * ("+" === k[1] ? 1 : -1))),
                i[c.idx] = e,
                this[h](i)))
            }
            )
    ...
    i.hook = function(b) {
        ...
        o(c, function(b, c) {
            ...
            a.fx.step[c] = function(b) {
                b.colorInit || (b.start = i(b.elem, c),
                b.end = i(b.end),
                b.colorInit = !0),
...
$(function() {
        ...
        $(".projectForm").each(function() {
            $(this).validate({
                ...
                messages: {
                    projectName: {
                        required: "请输入项目名称",
                        maxlenStr: "请输入有效的项目名称"
                    },
                    thePost: {
                        required: "请输入担任职务",
                        maxlenStr: "请输入有效的担任职务"
                    },
                    projectYearStart: {
                        required: "请选择开始时间",
                        checkProjectYear: "开始时间需早于结束时间"
                    },
                    projectMonthStart: {
                        required: "请选择开始时间",
                        checkProjectYear: "开始时间需早于结束时间"
                ...
                submitHandler: function(a) {
                    ...
                    $.ajax({
                        ...
                        b.success ? (c = b.content.projectExperience,
                        e = "",
                        3 == b.code ? "" != c ? (e += '<li data-id="' + c.id + '">',
                        ...
                        "" != c.projectRemark && (e += '<div class="dl1">' + c.projectRemark + "</div>"),
                        e += "</div></li>",
                        ...
                        d.obj.children(".projectEdit").addClass("dn")) : "" != $.trim(d.obj.children(".projectShow").children(".plist").html()) ? ($(a).remove(),
                        d.obj.children(".c_add").removeClass("dn")) : (d.obj.children(".projectEdit").addClass("dn"),
                        d.obj.children(".projectAdd").removeClass("dn")) : 4 == b.code ? (e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' + c.projectName + '" data-posName="' + c.positionName + '" data-startY="' + c.startYear + '" data-startM="' + c.startMonth + '" data-endY="' + c.endYear + '"' + 'data-endM="' + c.endMonth + '">' + c.projectNameAndRemark + '<span class="c9">（' + c.startDate + "-" + c.endDate + "）</span></div>",
                        "" != c.projectRemark && (e += '<div class="dl1">' + c.projectRemark + "</div>"),
                        e += "</div>",
                        $(a).parent("li").html(e)) : 2 == b.code && ($(a).parent("li").remove(),
                        0 == d.obj.children(".projectShow").children(".plist").children("li").length && d.AddCancel),
            ...
            $(this).validate({
                ...
                submitHandler: function(a) {
                    ...
                    $.ajax({
                        ...
                        3 == b.code ? "" != e ? (c += '<li data-id="' + e.id + '"><div class="workList c7">' + '<i class="sm_del dn"></i>' + '<i class="sm_edit dn"></i>',
                        e.url && (d = "http://" == e.url.substring(0, 7) || "https://" == e.url.substring(0, 8) ? e.url : "http://" + e.url,
                        c += '<div class="f16">网址：<a href="' + d + '" target="_blank">' + e.url + "</a></div>"),
                        ...
                        h.obj.children(".c_add").removeClass("dn")) : "" != $.trim(h.obj.children(".workShow").children(".slist").html()) ? ($(a).remove(),
                        h.obj.children(".c_add").removeClass("dn")) : (h.obj.children(".workEdit").addClass("dn"),
                        h.obj.children(".workAdd").removeClass("dn")) : 4 == b.code ? (c += '<div class="workList c7"><i class="sm_del dn"></i><i class="sm_edit dn"></i>',
                        e.url && (d = "http://" == e.url.substring(0, 7) || "https://" == e.url.substring(0, 8) ? e.url : "http://" + e.url,
                        c += '<div class="f16">网址：<a href="' + d + '" target="_blank">' + e.url + "</a></div>"),
                        c += "<p>" + e.workName + "</p>" + "</div>",
                        placeholderFn(),
                        $(a).parent("li").html(c)) : 2 == b.code && ($(a).parent("li").remove(),
                        "" == $.trim(h.obj.children(".workShow").children(".slist").html()) && h.AddCancel),
    ...
    jQuery.validator.addMethod("checkProjectYear", function(a, b) {
    ...
    jQuery.validator.addMethod("checkSchoolYear", function(a, b) {
    ...
    $("#resumeNameForm").validate({
        ...
        submitHandler: function(a) {
            ...
            $.ajax({
                ...
                if (b.success) {
                    var c = "";
                    c = b.content.resumeName.length > 18 ? b.content.resumeName.substring(0, 15) + "..." : b.content.resumeName,
    ...
    $("#basicInfo .c_edit").bind("click", function() {
        ...
        $("#select_topDegree").css("color", "#333"),
        $("#select_workyear").css("color", "#333"),
        "" != e && 
        ($("#currentState").val(e),
        $("#select_currentState").css("color", "#333")),
    ...
    $("#profileForm").validate({
        ...
        submitHandler: function(a) {
            ...
            $.ajax({
                ...
                var c, d, e;
                $("#resubmitToken").val(b.resubmitToken),
                b.success ? "/resume/myresume.html" == b.content.url ? window.location.href = ctx + b.content.url : (c = b.content.resume,
                d = c.workYear,
                "应届毕业生" != d ? (d += "工作经验",
                $("#workExperience h2 span").text("（投递简历时必填）")) : $("#workExperience h2 span").text(""),
                e = c.name,
                "" != c.sex && (e += " | " + c.sex),
    ...
    $("#box_expectSalary").on("click", "ul li", function(a) {
        a.stopPropagation();
        var b = $(this).text();
        $("#select_expectSalary").css("color", "#333").removeClass("select_focus"),
        $("#expectSalary").val(b),
        $("#box_expectSalary").hide(),
    ...
    b = {
        ...
        Edit: function() {
            "" == this.expectCityVal ? ($("#expectCity").val(""),
            $("#select_expectCity").val("期望城市，如：北京").css("color", "#999")) : ($("#expectCity").val(this.expectCityVal),
            $("#select_expectCity").val(this.expectCityVal).css("color", "#333")),
          ...
          /*  "" == this.expectSalaryVal ? (
            $("#select_expectSalary").val("期望月薪").css("color", "#999")) : ($("#expectSalary").val(this.expectSalaryVal),
            $("#select_expectSalary").val(this.expectSalaryVal).css("color", "#333")),*/
            placeholderFn(),
            this.obj.find(".expectAdd").addClass("dn"),
            this.obj.find(".expectShow").addClass("dn"),
            this.obj.find(".c_edit").addClass("dn"),
    ...
    $("#expectForm").validate({
        ...
        submitHandler: function(a) {
            ...
            $.ajax({
                ...
                if ($("#resubmitToken").val(g.resubmitToken),
                g.success) {
                    if (c || d || e || f) {
    ...
    $(".box_companyYearStart").on("click", "ul li", function(a) {
        ...
        $(this).parents(".box_companyYearStart").siblings(".companyYearStart").hasClass("error") && $(this).parents(".experienceForm").validate().element(c.find(".companyYearStart")),
        c.find(".companyYearEnd").hasClass("error") ? $(this).parents(".experienceForm").validate().element(c.find(".companyYearEnd")) : c.find(".companyMonthEnd").hasClass("error") && $(this).parents(".experienceForm").validate().element(c.find(".companyMonthEnd"))
    }),
    ...
    $(".box_companyMonthStart").on("click", "ul li", function(a) {
        ...
        c = $(this).parents(".experienceForm"),
        $(this).parents(".box_companyMonthStart").siblings(".companyMonthStart").hasClass("error") && $(this).parents(".experienceForm").validate().element(c.find(".companyMonthStart")),
        c.find(".companyYearEnd").hasClass("error") ? $(this).parents(".experienceForm").validate().element(c.find(".companyYearEnd")) : c.find(".companyMonthEnd").hasClass("error") && $(this).parents(".experienceForm").validate().element(c.find(".companyMonthEnd"))
    }),
    ...
    $(".box_companyYearEnd").on("click", "ul li", function(a) {
        ...
        "至今" == $.trim(b) ? (d.find(".companyMonthEnd").val("至今"),
        d.find(".select_companyMonthEnd").css("color", "#333").val("至今"),
        d.find(".select_companyMonthEnd").unbind("click")) : ("至今" == $.trim(c) && (d.find(".companyMonthEnd").val(""),
        d.find(".select_companyMonthEnd").css("color", "#999").val("结束时间")),
    ...
    c = {
        ...
        Edit: function(a) {
            var h, i, b = a.parent("li").attr("data-id"), c = a.siblings("span").attr("data-startYear"), d = a.siblings("span").attr("data-endYear"), e = a.siblings("span").attr("data-startMonth"), f = a.siblings("span").attr("data-endMonth");
    ...
    $(".experienceForm").each(function() {
        $(this).validate({
            ...
            messages: {
                companyName: {
                    required: "请输入有效的公司名称，如：拉勾网",
                    maxlenStr: "请输入有效的公司名称，如：拉勾网"
                },
                positionName: {
            ...
            submitHandler: function(a) {
                ...
                $.ajax({
                    ...
                    var d, e, f;
                    if ($("#resubmitToken").val(b.resubmitToken),
                    b.success) {
                        for (d = b.content.workExperiences,
                        e = "",
                        f = 0; f < d.length; f++)
    ...
    $("#projectExperience").on("click", ".box_projectYearEnd li", function(a) {
        ...
        "至今" == $.trim(b) ? (d.find(".projectMonthEnd").val("至今"),
    ...
    d = {
        ...
        Del: function(a) {
            ...
            $.ajax({
                ...
                b.success ? (a.parents("li").remove(),
                $("ul.plist li:last-child").addClass("noborder"),
                ("" == b.content.projectExperiences || null == b.content.projectExperiences) && (d.obj.children(".projectShow").addClass("dn"),
    ...
    f = {
        ...
        Del: function(a) {
            ...
            $.ajax({
                ...
                b.success ? (a.parent("li").remove(),
                "" == b.content.educationExperiences || null == b.content.educationExperiences ? (f.obj.children(".educationalShow").addClass("dn"),
                f.obj.children(".educationalEdit").addClass("dn"),
                f.obj.children(".educationalAdd").removeClass("dn"),
                f.obj.children(".c_add").addClass("dn")) : f.obj.children(".educationalShow").children(".educationalForm").hide(),
                $("#lastChangedTime span").text(b.content.refreshTime),
                $("#resumeScore .which div").text(b.content.infoCompleteStatus.msg),
                $("#resumeScore .which span").attr("rel", b.content.infoCompleteStatus.nextStage),
                scoreChange(b.content.infoCompleteStatus.score),
        ...
        $(this).validate({
            ...
            submitHandler: function(a) {
                ...
                $.ajax({
                    ...
                    if ($("#resubmitToken").val(b.resubmitToken),
                    b.success) {
                        for (c = b.content.educationExperiences,
                        d = "",
                        e = 0; e < c.length; e++)
                            d += 0 == e % 2 ? '<li data-id="' + c[e].id + '" class="clear">' : '<li data-id="' + c[e].id + '">',
    ...
    g = {
        ...
        Cancel: function() {
            this.text ? (this.obj.children(".descriptionAdd").addClass("dn"),
            this.obj.children(".descriptionShow").removeClass("dn"),
            this.obj.children(".descriptionEdit").addClass("dn"),
            this.obj.children(".c_edit").removeClass("dn")) : (this.obj.children(".descriptionAdd").removeClass("dn"),
            this.obj.children(".descriptionShow").addClass("dn"),
            this.obj.children(".descriptionEdit").addClass("dn")),
            k(this.obj)
        }
    ...
    $(".descriptionForm").validate({
        ...
        submitHandler: function(a) {
            ...
            $.ajax({
                ...
                var c, d;
                $("#resubmitToken").val(b.resubmitToken),
                b.success ? (c = b.content.resume,
                d = "",
                c.myRemark ? (d = c.myRemark,
                g.text = c.myRemark,
