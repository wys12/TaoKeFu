...
!function(a, b) {
    ...
    a.fn.hoverdir = function(b) {
        ...
        return "string" == typeof b ? (d = Array.prototype.slice.call(arguments, 1),
        this.each(function() {
            return e ? a.isFunction(e[b]) && "_" !== b.charAt(0) ? (e[b].apply(e, d),
            void 0) : (c("no such method '" + b + "' for hoverdir instance"),
            void 0) : (c("cannot call methods on hoverdir prior to initialization; attempted to call method '" + b + "'"),
            void 0)
        })) : this.each(function() {
...
window.Modernizr = function(a, b, c) {
    ...
    function j(a, b, c) {
        ...
        return f(b, "string") || f(b, "undefined") ? h(e, b) : (e = (a + " " + v.join(d + " ") + d).split(" "),
        i(e, b, c))
    }
    var r, B, D, E, k = "2.6.2", l = {}, m = !0, n = b.documentElement, o = "modernizr", p = b.createElement(o), q = p.style, t = ({}.toString,
    "Webkit Moz O ms"), u = t.split(" "), v = t.toLowerCase().split(" "), w = {}, z = [], A = z.slice, C = {}.hasOwnProperty;
    D = f(C, "undefined") || f(C.call, "undefined") ? function(a, b) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function(a) {
        ...
        d = function() {
            ...
            Object(g) === g ? g : f) : b.apply(a, c.concat(A.call(arguments)))
        }
    }
    ),
    ...
    ;
    for (E in w)
        D(w, E) && (B = E.toLowerCase(),
        l[B] = w[E](),
        z.push((l[B] ? "" : "no-") + B));
    return l.addTest = function(a, b) {
        if ("object" == typeof a)
            for (var d in a)
                D(a, d) && l.addTest(d, a[d]);
        else {
            if (a = a.toLowerCase(),
            l[a] !== c)
                return l;
    ...
    function(a, b) {
        ...
        var m, q, r, j = a.html5 || {}, k = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, l = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, n = "_html5shiv", o = 0, p = {};
        !function() {
            try {
                var a = b.createElement("a");
                a.innerHTML = "<xyz></xyz>",
                m = "hidden" in a,
                q = 1 == a.childNodes.length || function() {
                    b.createElement("a");
...
$(function() {
    function d() {
        return window.innerHeight ? c = window.innerHeight : document.body && document.body.clientHeight && (c = document.body.clientHeight),
        document.documentElement && document.documentElement.clientHeight && (c = document.documentElement.clientHeight),
        c
    }
    function g(a) {
        a >= 0 && (f = a),
        ...
        $(".thumbs li").eq(f).addClass("current"),
        $(".banner_bg").animate({
            "margin-top": "-" + 160 * f + "px"
        }, 200),
        f++,
    ...
    var a, c, e, f, h;
    $("#icon_qq ,#icon_wb").click(function() {
        $.colorbox.close(),
    ...
    $("#sidebar .menu_box").each(function(a) {
        $(this).hoverDelay({
            hoverDuring: 200,
            hoverEvent: function() {
                switch (a) {
    ...
    $(window).scroll(function() {
        var b = $(window).scrollTop()
          , c = d()
          , e = $("#sidebar").height();
        a.top <= b && c > e ? $("#sidebar").addClass("fixed") : $("#sidebar").removeClass("fixed")
    }),
    c = 0,
    $(".hotabbing li").bind("click", function() {
        $(this).addClass("current").siblings().removeClass("current");
        var a = $(this).index();
        $("#hotList ul.hot_pos").each(function() {
            $(this).fadeOut(200)
        }),
        $("#hotList ul.hot_pos").eq(a).fadeIn(200)
    }),
    $(".tipExpire .expire_close").bind("click", function() {
        var a = $.cookie("showExpriedIndex");
        $.cookie("showExpriedIndex", a - 1),
        $(this).parent(".tipExpire").hide()
    }),
    $("#resumeScore .xScore").bind("click", function() {
        $(this).parent("#resumeScore").hide(),
        $.ajax({
            type: "POST",
            data: {},
    ...
    e = $(".banner_bg li").length,
    f = 1,
    $(".banner_bg").css("height", 160 * e + "px"),
    h = setInterval(g, 5e3),
