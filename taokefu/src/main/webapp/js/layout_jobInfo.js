...
function load(urlStr){
	...
	$('#job-datagrid-2').datagrid({
		...
		columns:[[
		          ...
		          { field:'job_tags',title:'职位标签',width:80,align:'center'},
		          ...
		          { field:'job_min_salary',title:'最小薪资(k)',width:80,align:'center'},
		          { field:'job_max_salary',title:'最大薪资(k)',width:80,align:'center'},
		          ...
		          { field:'job_rests',title:'其他',width:80,align:'center'},
