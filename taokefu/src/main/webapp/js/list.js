...
function shouInfo(data){
	...
	for(var i=0;i<data.length;i++){
		...
		+'</div><div class="hot_pos_r"><div class="apply"><a href="toudi.html" onclick="toudi('+data[i].job_id+')">投个简历</a></div><div class="mb10"><a href="'+data[i].pro_link+'" title="'+data[i].comp_name+'" target="_blank">'+data[i].comp_name+'</a></div>'
...
function toudi(data){
	$.post("job/sendCompany",{job_id:data},"json");
}
