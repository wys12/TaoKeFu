...
function shouInfo(number){
	...
	$.post("tkfuser/findTkfUser",{us_id:number.l_id},function(data){console.info(1);
		listTkfUser=data;
	}
	,"json");
	$.post("tkfuser/findUsResume",params,function(data){console.info(2);
		listUsResume=data;
	...
	$.post("tkfuser/findExperience",params,function(data){console.info(3);
		listExperience=data;
	...
	$.post("tkfuser/findSucceed",params,function(data){console.info(4);
		listSucceed=data;
	...
	$.post("tkfuser/findEducationa",params,function(data){
		setTimeout(function showInfos(){console.info(5);
